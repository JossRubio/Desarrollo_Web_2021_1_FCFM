...
CREATE TABLE IF NOT EXISTS `tarea2`.`comentario_foto` (
...
-- -----------------------------------------------------
-- Inserción de variables, estas fueron el resultado tras realizar las ultimas pruebas de forma local para la tarea 4.
-- -----------------------------------------------------

INSERT INTO avistamiento (id, comuna_id, dia_hora, sector, nombre, email, celular) VALUES (1, 130302, '2021/05/08 19:36:41', 'Eyzaguirre', 'Jose Manuel Rubio', 'jo.manuel@hotmail.com', '9758847521');
INSERT INTO avistamiento (id, comuna_id, dia_hora, sector, nombre, email, celular) VALUES (2, 130302, '2021/05/08 19:36:41', 'Eyzaguirre', 'Jose Manuel Rubio', 'jo.manuel@hotmail.com', '9758847521');
INSERT INTO detalle_avistamiento (id, dia_hora, tipo, estado, avistamiento_id) VALUES (1, '2021/05/08 19:36:41', 'insecto', 'muerto', 1);
INSERT INTO detalle_avistamiento (id, dia_hora, tipo, estado, avistamiento_id) VALUES (2, '2021/05/08 19:36:41', 'insecto', 'muerto', 2);
INSERT INTO detalle_avistamiento (id, dia_hora, tipo, estado, avistamiento_id) VALUES (3, '2021/10/07 22:25:31', 'arácnido', 'vivo', 2);
INSERT INTO foto (id, ruta_archivo, nombre_archivo, detalle_avistamiento_id) VALUES (1, '178f41f9a7cc6f04f92d9', 'vegeta_insecto.jpg', 1);
INSERT INTO foto (id, ruta_archivo, nombre_archivo, detalle_avistamiento_id) VALUES (2, '278f41f9a7cc6f04f92d9', 'vegeta_insecto.jpg', 2);
INSERT INTO foto (id, ruta_archivo, nombre_archivo, detalle_avistamiento_id) VALUES (3, '38603c017d53c71f9aa6b', 'mariposa.jpg', 2);
INSERT INTO foto (id, ruta_archivo, nombre_archivo, detalle_avistamiento_id) VALUES (4, '4d00d780ca1fe72026d53', 'saltamontes.jpg', 2);
INSERT INTO foto (id, ruta_archivo, nombre_archivo, detalle_avistamiento_id) VALUES (5, '50dd4f11362dc471382ce', 'ARAÑA.jpg', 3);
INSERT INTO foto (id, ruta_archivo, nombre_archivo, detalle_avistamiento_id) VALUES (6, '6f4d8147048d9ea41bd96', 'libelula.jpg', 3);
INSERT INTO foto (id, ruta_archivo, nombre_archivo, detalle_avistamiento_id) VALUES (7, '75fe6386196142fe602d3', 'luciernaga.jpg', 3);
INSERT INTO foto (id, ruta_archivo, nombre_archivo, detalle_avistamiento_id) VALUES (8, '825d772f59deb4d6289ef', 'elbicho.jpeg', 3);
